...
namespace lamst_ma7ba_Api.Migrations
{
    ...
    [Migration("20210404131059_datestrig")]
    partial class datestrig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lamst_ma7ba_Api.Models.Image", b =>
                {
                    ...
                    b.HasIndex("ImageCatId");

                    b.ToTable("photos");
                });

            modelBuilder.Entity("lamst_ma7ba_Api.Models.ImageCat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("lamst_ma7ba_Api.Models.Image", b =>
                {
                    b.HasOne("lamst_ma7ba_Api.Models.ImageCat", "ImageCat")
                        .WithMany("images")
                        .HasForeignKey("ImageCatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
